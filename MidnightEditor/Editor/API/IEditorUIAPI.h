...
namespace aveng {
    ...
    */
    struct IEditorUIAPI {
        ...
        virtual std::vector<AnyInstanceHandle> uiSpawnMany(
            ModelRef modelRef,
        ...
        virtual std::vector<ModelId> uiListKnownModels() const = 0;
        virtual std::vector<AnyInstanceHandle> uiListInstances() const = 0;
        virtual std::vector<AnyInstanceHandle> uiListInstancesForModel(ModelId id) const = 0;
        ...
        virtual void uiPushStatusMessage(const char* msg) = 0;
    };
