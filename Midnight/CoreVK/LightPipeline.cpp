...
namespace aveng {
    bool LightPipeline::init(EngineDevice& engineDevice, VkPipelineLayout& pipelineLayout, VkPipeline& pipeline,
        ...
        /* No attributes in this pipeline */
        ...
        for (int i = 0; i < numColorAttachments; ++i) {
            ...
            if (i == 1) { // This is only to maintain compatibility with the Editor's renderpass
    ...
    void LightPipeline::cleanup(EngineDevice& engineDevice, VkPipeline& pipeline) {
