...
namespace aveng {
    ...
    bool LinePipeline::init(EngineDevice& engineDevice, VkRenderPass renderpass, VkPipelineLayout& pipelineLayout, VkPipeline& pipeline,
    ...
    void LinePipeline::cleanup(EngineDevice& engineDevice, VkPipeline& pipeline) {
