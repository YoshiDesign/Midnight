...
namespace aveng {
    ...
    glm::vec4 AssimpAnimChannel::getTranslation(float time) {
        ...
        case 1:
            ...
            break;
        default:
            std::printf("%s error: preState %i not implmented\n", __FUNCTION__, mPreState);
            break;
        }
        ...
        case 1:
            ...
            break;
        default:
            std::printf("%s error: postState %i not implmented\n", __FUNCTION__, mPostState);
            break;
        }
